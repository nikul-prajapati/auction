<!--Action Button-->
@if( Active::checkUriPattern( 'admin/bids' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.bids.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.bids.all' ) }}
            </a>
        </li>
        @permission( 'create-bid' )
            <li>
                <a href="{{ route( 'admin.bids.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.bids.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
