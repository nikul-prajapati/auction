<!--Action Button-->
@if( Active::checkUriPattern( 'admin/playerrecords' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.playerrecords.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.playerrecords.all' ) }}
            </a>
        </li>
        @permission( 'create-playerrecord' )
            <li>
                <a href="{{ route( 'admin.playerrecords.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.playerrecords.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
