<!--Action Button-->
@if( Active::checkUriPattern( 'admin/neerajs' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.neerajs.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.neerajs.all' ) }}
            </a>
        </li>
        @permission( 'create-neeraj' )
            <li>
                <a href="{{ route( 'admin.neerajs.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.neerajs.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
