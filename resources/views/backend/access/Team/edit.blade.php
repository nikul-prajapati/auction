        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    {{ Form::label('name', trans('validation.attributes.backend.access.users.Team_name'), ['class' => 'col-lg-2 control-label required']) }}
...
@section('after-scripts')
    <script type="text/javascript">
        Backend.Utils.documentReady(function(){
            ...
            Backend.Team.selectors.getPremissionURL = "{{ route('admin.get.permission') }}";
            Backend.Team.init("edit");
        });
        window.onload = function () {
            Backend.Team.windowloadhandler();
        };
