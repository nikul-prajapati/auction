...
@section ('title', trans('labels.backend.access.Team.management') . ' | ' . trans('labels.backend.access.Team.create'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.access.Team.management') }}
        <small>{{ trans('labels.backend.access.Team.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.access.Team.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}

        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.backend.access.Team.create') }}</h3>

                <div class="box-tools pull-right">
                    @include('backend.access.includes.partials.team-header-buttons')
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    {{ Form::label('Team Name', trans('validation.attributes.backend.access.users.Team_Name'), ['class' => 'col-lg-2 control-label required']) }}
...
<!-- 
               ...
               <!--  </div> --><!--form control-->
                ...
                <div class="edit-form-btn">
                    {{ link_to_route('admin.access.Team.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-md']) }}
