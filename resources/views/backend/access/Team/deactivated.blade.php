...
@section ('title', trans('labels.backend.access.Team.management') . ' | ' . trans('labels.backend.access.Team.deactivated'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.access.Team.management') }}
        <small>{{ trans('labels.backend.access.Team.deactivated') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.access.Team.deactivated') }}</h3>
        ...
        <div class="box-body">
            <div class="table-responsive data-table-wrapper">
                <table id="users-table" class="table table-condensed table-hover table-bordered">
                    <thead>
                        <tr>
                            <th>{{ trans('labels.backend.access.users.table.Team_name') }}</th>
                    ...
                    <thead class="transparent-bg">
                        <tr>
                            <th>
                                {!! Form::text('Text_name', null, ["class" => "search-input-text form-control", "data-column" => 0, "placeholder" => trans('labels.backend.access.users.table.Text_name')]) !!}
