...
@section('content')
    {{ Form::model($playerinformation, ['route' => ['admin.playerinformations.update', $playerinformation], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-playerinformation']) }}
