<!--Action Button-->
@if( Active::checkUriPattern( 'admin/details' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.details.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.details.all' ) }}
            </a>
        </li>
        @permission( 'create-detail' )
            <li>
                <a href="{{ route( 'admin.details.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.details.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
